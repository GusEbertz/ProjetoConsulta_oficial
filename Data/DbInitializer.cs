    ...
    internal void seed()
    {
      ...
      (
          new Atendente
          {
            ...
            Nome = "Projeto Consulta",
            Email = "projetoconsulta@hotmail.com.br",
            EmailConfirmed = true,
            UserName = "projetoconsulta@hotmail.com.br",
            NormalizedEmail = "PROJETOCONSULTA@HOTMAIL.COM.BR",
            NormalizedUserName = "PROJETOCONSULTA@HOTMAIL.COM.BR",
            PasswordHash = hasher.HashPassword(null, "Pa$$w0rd")
            //PasswordHash = "Password@1909"
          }
      );
